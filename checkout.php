   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="flat" required placeholder="e.g house address">
         </div>
         <div class="inputBox">
            <span>address line 01 :</span>
         ...
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" required placeholder="e.g. Hanoi">
         </div>
         <div class="inputBox">
            <span>state :</span>
            <input type="text" name="state" required placeholder="e.g. HCM City">
         </div>
         <div class="inputBox">
            <span>country :</span>
